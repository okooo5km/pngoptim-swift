...
let package = Package(
  ...
  targets: [
    .binaryTarget(
      name: "PNGOptimCore",
      url:
        "https://github.com/okooo5km/pngoptim-swift/releases/download/v0.4.2/PNGOptimCore.xcframework.zip",
      checksum: "14bd9b549ee1024f7e30795ba5ca3063a7e8547f8cc6277c50560efe8ec1adc9"
    ),
