...
let package = Package(
  ...
  targets: [
    .binaryTarget(
      name: "PNGOptimCore",
      url:
        "https://github.com/okooo5km/pngoptim-swift/releases/download/v0.4.3/PNGOptimCore.xcframework.zip",
      checksum: "e5d6706367d24f8796fc71b73d7e5cd9ee81da769ce354988f070b46ee8ca21e"
    ),
